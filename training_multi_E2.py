...
def run(rank, n_gpus):
    ...
    def train(epoch, loader):
        ...
        for batch_idx, batch in enumerate(trainloader):
            ...
            # print(pro.shape, tim.shape, lengths)
            predict = model.module.inference(pro, tim, lengths).squeeze()
            # print(predict.shape, tar.shape)
            mse_loss = mse(predict, tar.transpose(1,2))
